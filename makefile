...
# 項目源文件
SRCS = src/main.cpp src/Game.cpp src/Snake.cpp src/Fruit.cpp src/Mine.cpp src/ScoreBoard.cpp
HDRS = include/Game.h include/Snake.h include/Fruit.h include/Mine.h include/ScoreBoard.h
